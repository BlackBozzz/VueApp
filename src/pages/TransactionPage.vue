        ...
        <q-page-container>
            ...
            <div class="row justify-between q-mx-lg q-my-md">
                <div class="column q-ma-none">
                    ...
                    <MyButton class="button" :type="'plus'" @btn-click="btnEdit"></MyButton>
                </div>
            ...
            <div class="column q-my-lg q-mx-lg">
                ...
                <div class="text-body1 text-deep-purple q-mt-lg q-mb-xl">Supporting line text lorem ipsum dolor sit amet, consectetur.</div>   
            </div>
